  ...
  return (
    <main>
      ...
      <section className="min-h-screen flex flex-col justify-center 
        items-center bg-gradient-to-b form-purple-300 to-pink-100 text-center">
          ...
          <div className="flex flex-col items-center justify-center h-screen -mt-40">
            ...
            <p className="text-lg max-w-xl" style={{color:"#50250c"}}>
              This is my portfolio for my 4th semester in my computer science degree at UCL Erhvervsakademi og Proffesionshøjskole in Denmark.
            </p>
            <p className="text-lg max-w-l" style={{color:"#50250c"}}>
              ...
              Furthermore, we wish to implement a role for the schools and clubs to register, so these can add the events and competitions they wish to host. Thereafter the equestrians can register to attend these events. 
            </p>
          </div>
      </section>
    </main>
