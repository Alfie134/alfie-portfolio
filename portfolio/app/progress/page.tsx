...
const weeks = [
    { label: "August 18th – 24th ", content: `This week we focused on designing and finishing our wireframes for out web application and the app. At this point we do still need to elaborate on them, so they include the different roles the users can have in our application.
    ...
    {label: "August 25th – 31st ", content: `This week was focused on getting started on our project and starting the development process. 
    ...
    { label: "September 8th – 14th", content: `For this week we’ve had quite a set of goals divided between the different group members. 
        Mathilde and I, who are specialising in frontend are wanting to study JavaScript further and finish LinkedIn Learning course on the subject. 
        https://www.linkedin.com/learning/javascript-essential-training/javascript-the-soil-from-which-the-modern-web-grows?u=57075649. 
        ...
        Our group made the decision, to create a Gantt chart to visualise our plan for the development of the project. Furthermore, we decided after a meeting with a teacher, 
        ...
        so they fit our decisions, but have decided it’s not something we prioritise as of right now. We also decided on some login decisions, 
        ...
        Because of the decisions and our planning, we're not well equipped to begin our work, and all know what our tasks are for the upcomming week. ` 
    },

    { label: "September 15th – 21st ", content: `Last week I made the decion to redo my portfolio and change the framework from Angular to React using next.js, 
